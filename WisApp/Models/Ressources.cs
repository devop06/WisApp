...
namespace WisApp.Models
{
    public class Ressources
    {
        ...
        private static void initArticle()
        {
            ...
            listArticle.Add(new Article() { id = 3, Date = "20/03/2015", Titre = "Les Bleus sont arrivés à Clairefontaine", Heure = "14:23", Description = "Les bleus sont arrivés sans se presser...", Content = "Les bleus sont arrivés sans se presser...", Auteur = "un autre", Image = "http://i1.eurosport.com/2015/03/29/1446228-30921410-1600-900.jpg", Latitude = 48.61237, Longitude = 1.9084890000000314 });
            listArticle.Add(new Article()
            {
                id = 4,
